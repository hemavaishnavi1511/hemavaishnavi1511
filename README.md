...
public class Hemavaishnavi {
    ...
    public String getDailyRoutine() {
        return "Code → Optimize → Learn → Repeat";
    }
}
```
...
**Tech:** `Java` `Spring Boot` `RESTful APIs` `Design Patterns`
...
**Tech:** `Python` `Scikit-learn` `Jupyter Notebook` `OpenCV`
...
I believe in writing code that not only works but is also elegant, maintainable, and easy to understand. Every line should tell a story, and every function should have a clear purpose.
